...
public class ConferenceEditionTableModel extends AbstractTableModel {
	...
	public String getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case COLUMN_TITLE:
			returnValue = DatabaseHelper.get().getConferenceEditionName(conferenceEdition);
			break;
		case COLUMN_YEAR:
			returnValue = String.valueOf(conferenceEdition.getYear());
			break;
		case COLUMN_EDITION:
			returnValue = DatabaseHelper.get().getConferenceEditionProceeding(conferenceEdition);
			break;
		default:
