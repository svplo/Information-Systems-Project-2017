...
public class ProceedingsUpdateUI extends JPanel {
	...
	/*
	 * private Publication getFieldData() { Publication p = new Publication(); p.setTitle(titleField.getText()); p.setAuthors(authorsField.getText()); p.setConferences(conferenceField.getText()); p.setProceedings(proceedingsField.getText()); p.setYear(Integer.parseInt(yearField.getText())); p.setPages(Integer.parseInt(pagesField.getText())); return p; }
	 *
	 * private void setFieldData(Publication p) { titleField.setText(String.valueOf(p.getTitle())); authorsField.setCaret(p.getAuthors()); conferenceField.setText(p.getConferences()); proceedingsField.setText(p.getProceedings()); yearField.setText(p.getYear()); pagesField.setText(p.getPages()); }
	 *
