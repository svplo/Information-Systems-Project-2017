...
public class ProceedingsWindow extends JFrame {
	...
	public ProceedingsWindow() {
	    ...
	    //TODO get only sublist
		allPublications = DatabaseHelper.getAllProceedings();
	      ...
	      table.addMouseListener(new MouseAdapter() {
	          public void mouseClicked(MouseEvent e) {
	             if (e.getClickCount() == 2) {
	                 ...
	                 //TODO return only one instance
	            	 Publication publications = ((List<Publication>) currentPublications).get(row);
