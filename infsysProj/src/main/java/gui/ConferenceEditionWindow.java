...
public class ConferenceEditionWindow extends JFrame {
	...
	List<ConferenceEdition> allConferenceEdition;
	List<ConferenceEdition> currentConferenceEdition;
	ConferenceEditionTableModel tableModel;
...
*/
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new ConferenceEditionWindow().setVisible(true);
			}
		});
